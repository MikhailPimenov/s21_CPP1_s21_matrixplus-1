...
namespace {
    ...
    TEST(InverseMatrixTests, Test7) {
        ...
        const S21Matrix actual = m1.InverseMatrix();
        const S21Matrix expected({
            { -0.09539842873176206501,	 0.23681257014590347919,	 0.14702581369248035913,	 0.037037037037037037,	    -0.14814814814814814814  },
            {  0.04208754208754208754,	-0.16329966329966329967,	-0.094276094276094276094,	 0.77777777777777777775,	-0.11111111111111111111  },
            { -0.01290684624017957352,	 0.39674523007856341191,	 0.0022446689113355780032,	-0.5185185185185185185,	     0.074074074074074074074 },
            { -0.02581369248035914704,	-0.20650953984287317619,	 0.0044893378226711560064,	-0.037037037037037037,	     0.14814814814814814814  },
            {  0.24354657687991021324,	-0.051627384960718294048,	 0.0011223344556677890016,	-0.25925925925925925925,	 0.037037037037037037037 },
        });
